...
// Old docs/troubleshooting.html hero, ported (#1593 Phase 3-4). Same
// structure as components/faq/Hero.tsx / components/why/Hero.tsx. See
// content/troubleshooting.ts's troubleshootingContent comment for why the JA
// h1 needs no zero-width-space reinsertion (unlike faq.ts's).
