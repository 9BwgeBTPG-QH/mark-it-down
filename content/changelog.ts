...
// old page's DOM order). Only the single newest entry (v2.2.10) carries
// `latest`/`defaultOpen`; all other entries omit both fields rather than
// writing them out as `false` (see content/troubleshooting.ts's own
// `defaultOpen` convention). Inline <strong>/<code> formatting inside the
// old <li> markup is flattened to plain text, following the same precedent
// documented in content/okf.ts.
//
  ...
  en: [
      ...
      sections: [
        {
          title: 'New Features',
          items: [
            { term: "Open notes from Chrome's address bar", description: 'Type mid and press Space in the address bar to search notes by title. Press Enter to open in a new tab — keyboard only, no mouse required.' },
            ...
            { term: 'Web Clipper: ruby text → Aozora notation', description: 'Pages with <ruby> annotations now convert to 漢字《かんじ》 notation automatically. Long articles with footnotes, tables, code blocks, and images also clip more accurately.' },
          ],
        },
        {
          title: 'Fixed',
      ...
      sections: [
        {
          title: 'New Features',
          items: [
            { term: 'RSS clip source URL in frontmatter', description: 'Saved RSS articles now include source_url in frontmatter automatically. The save success toast also includes an Undo action to back out without losing the trail.' },
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'Highlight color per theme', description: 'The ==highlight== background color is now correctly tuned for each of the four themes.' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Paragraph block link copy', description: 'Select text in the floating toolbar and choose "Copy block link" to copy a direct link to that paragraph ([[Note#^id]]).' },
          ],
        },
        {
          title: 'Fixed',
          items: [
            { term: 'Wikilinks not rendering on input', description: 'Typing [[note name]] now renders the link decoration immediately without requiring a page reload.' },
            { term: 'Horizontal rule not inserting on sequential input', description: 'Typing --- one character at a time now correctly inserts a horizontal rule. Paste was unaffected; keyboard entry was broken.' },
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { term: 'RSS Conditional GET', description: 'Feeds now send If-None-Match / If-Modified-Since headers. Unchanged feeds return a 304 and skip parsing entirely — less bandwidth, faster refresh cycles.' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Obsidian Wikilinks + Autocomplete', description: 'Write [[Note Title]] or [[Title|Alias]]. Resolved links are green, unresolved red, ambiguous amber. Ctrl+Click navigates directly to the target note. Type [[ to open a fuzzy-search autocomplete popover — Arrow/Enter/Tab to confirm, Esc to dismiss.' },
            { term: 'Backlink Panel', description: 'Inbound [[links]] pointing to the current note appear at the bottom of the TOC and in the Right Panel. Click or press Enter to jump to the source note. Hidden when there are no backlinks.' },
            ...
            { term: 'Obsidian Properties + Logseq Export Presets', description: 'New built-in presets for Obsidian Properties format and Logseq :: notation, alongside the existing CommonMark / GFM / Hugo / Obsidian copy targets.' },
      ...
      sections: [
        {
          title: 'New Features',
          items: [
            { term: 'RSS Reader', description: 'Read feeds in Mark It Down, move through items with j/k, open with Enter, and save selected articles to Inbox as Markdown.' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'LaTeX Environment Paste', description: 'Paste \\begin{equation|align|aligned|gather|cases} and it becomes $$...$$ automatically. Pure LaTeX (no surrounding Markdown) now converts on plain Ctrl+V too.' },
            { term: 'JSON on Plain Ctrl+V', description: 'JSON → Markdown was Ctrl+Shift+V only. Now plain paste works. Arrays become tables, objects become key-value lists. Objects nested 3+ deep fall back to a ```json fenced block.' },
            { term: 'HTML Formatting Tags', description: '<strong>/<b>/<em>/<i>/<code> now convert to **/*/` instead of being stripped. Web and AI clips keep their emphasis.' },
            { term: 'Hunk-Level Conflict Navigation', description: 'In the Conflict Resolution modal, j/k move between hunks and Shift+←/Shift+→ cherry-pick the focused hunk as local or remote. Partial merges stay keyboard-only.' },
          ],
        },
        {
          title: 'Improvements',
          items: [
            ...
            { term: 'Smart Typography Performance', description: 'Cut state.doc.resolve(from) calls from twice-per-keystroke to once, and folded ancestor checks into an inline loop. A small fix on a hot path.' },
          ],
        },
        {
          title: 'Bug Fixes',
          items: [
            ...
            { term: 'Math Block Placeholder', description: 'Fixed math blocks displaying as raw placeholders after ```math fence conversion, by re-detecting the converted string and scheduling CodeMirror init.' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: 'New Features',
          items: [
            { term: 'Auto Text Conversion', description: 'Type -> for → and -- for —. Conversion is skipped inside code blocks.' },
            { term: 'Mermaid Semantic Colors', description: 'Use :::frontend, :::backend, :::database, and other class names in Mermaid diagrams for theme-matched colors.' },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'Slash Commands', description: 'Fixed / commands becoming unresponsive after editor re-display.' },
      ...
      sections: [
        {
          title: 'New Features',
          items: [
            { term: 'Web Clipper CSS Selector Targeting', description: 'Dropdown to select page sections (main, article, #content) before clipping. Grab just the part you need from long pages.' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Chat Format Smart Paste', description: 'Pastes from Slack, Discord, and WhatsApp auto-convert to standard Markdown. Handles <url|text> links, ||spoiler||, and >>> blockquotes.' },
            ...
            { term: 'LaTeX Export', description: 'Convert Markdown to LaTeX and output as a .tex file. Designed for academic writing and reports.' },
            ...
            { term: 'Heading Auto-Numbering', description: 'Automatically number H2–H6 headings with CSS counters. Toggle with /num in the slash menu.' },
            { term: 'LaTeX Autocomplete in Math Blocks', description: 'Type \\ inside a math block to see 108 LaTeX command suggestions — Greek letters, operators, arrows, and more.' },
            ...
            { term: 'Cross-Note Find & Replace', description: 'Ctrl+Shift+H to search and replace across all notes. Folder filter chips, match counter ("3 / 17"), and Ctrl+F for search-only mode.' },
          ],
        },
        {
          title: 'Changed',
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'x.com Callouts', description: "Grok's [!NOTE]/[!WARNING] callouts now preserved when clipping from x.com" },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Notes in Command Palette', description: 'Find and open any note by name from Ctrl+Shift+P' },
          ],
        },
        {
          title: 'Theme & Design',
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { term: 'L1 / L2 Structure', description: 'Common actions up front, advanced actions behind ··· — less clutter, same power' },
            ...
            { term: 'Callout Type Switcher', description: 'Cycle through NOTE/TIP/IMPORTANT/WARNING/CAUTION with Ctrl+Shift+A or the hover toolbar' },
          ],
        },
        {
          title: 'Tables & UX',
        ...
        },
        {
          title: 'Bug Fixes',
          items: [
            { term: 'Strikethrough Typing', description: '~~text~~ now converts immediately as you type, including after IME input' },
      ...
      sections: [
        {
          title: 'Export Suite',
          items: [
            { term: 'PDF Export', description: 'Print to PDF via browser dialog — auto page breaks at H1, --- converted to page breaks' },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'Syntax Previews', description: 'Descriptions show what gets inserted: graph TD — Decision flows with arrows' },
        ...
        },
        {
          title: 'Bug Fixes',
          items: [
            { term: 'TOC on Windows', description: 'Fixed heading extraction failing on \\r\\n line endings' },
            { term: 'Copy as Text', description: 'LaTeX $...$ and escape characters now stripped correctly' },
            { term: 'Dollar Amounts', description: '$50 no longer misidentified as LaTeX' },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: 'Note Navigation', description: 'Ctrl+Alt+PgUp/PgDn to jump between notes in the same folder' },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: 'Footnotes', description: 'Academic-style [^label] with click-to-jump' },
            { term: 'Emoji Shortcodes', description: 'Type :smile: to insert 😄' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          items: [
            ...
            { term: 'Keyboard Navigation', description: 'Heading jump (Ctrl+↑/↓), page scroll' },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: 'Math Rendering', description: 'Inline $...$, block $$...$$, with enlarge button' },
  ...
  ja: [
      ...
      sections: [
        {
          title: '新機能',
          items: [
            { term: 'アドレスバーからノートを開く（omnibox 連携）', description: 'Chrome のアドレスバーで mid と入力してスペースを押すと、ノートをタイトルで検索できる。Enter を押すと新規タブで開く。マウス不要。' },
            ...
            { term: 'Web Clipper：ルビ付き文章を青空文庫記法に変換', description: '<ruby> タグを含むページを取り込むと、漢字《かんじ》 形式に自動変換される。脚注・表・コードブロック・画像を含む長文ページの取り込み品質も改善した。' },
          ],
        },
        {
          title: 'バグ修正',
      ...
      sections: [
        {
          title: '新機能',
          items: [
            { term: 'RSSクリップに出典 URL を自動記録', description: 'RSS記事を保存すると frontmatter に source_url が自動的に入るようになった。保存トーストには Undo アクションも追加され、すぐ取り消せる。' },
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'ハイライト色をテーマ別に調整', description: '==ハイライト== の背景色が4テーマそれぞれで適切に表示されるよう調整した。' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: '段落ブロックリンクのコピー', description: 'フローティングツールバーから「ブロックリンクをコピー」を選ぶと、その段落への直接リンク（[[ノート名#^id]]）がクリップボードに入る。' },
          ],
        },
        {
          title: 'バグ修正',
          items: [
            { term: 'ウィキリンクが入力後すぐに表示されない問題', description: '[[ノート名]]を入力した直後にリンクの装飾が反映されず、リロードが必要だったバグを修正。' },
            { term: '逐次入力での水平線挿入不具合', description: '-を3回連続して入力しても水平線が挿入されなかった問題を修正。ペーストでは問題なかったが、キーボードからの入力が壊れていた。' },
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          title: '高速化と堅牢化',
          items: [
            { term: 'RSS Conditional GET', description: 'フィードリクエストに If-None-Match / If-Modified-Since ヘッダーを送信するようになった。更新のないフィードは 304 を返しパースをスキップ——通信量削減、取得サイクル高速化。' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Obsidian Wikilink ＋ オートコンプリート', description: '[[タイトル]] / [[タイトル|表示名]] で書ける。[[ と入力するとファジー検索のオートコンプリートポップオーバーが開き、矢印/Enter/Tab で確定、Esc でキャンセル。resolved は緑、unresolved は赤、ambiguous は黄色で表示。Ctrl+Click でリンク先ノートに移動。' },
            { term: 'バックリンクパネル', description: '現在のノートへの被リンク（[[links]]）が目次下部と右パネルに表示される。クリックまたは Enter でリンク元ノートへジャンプ。バックリンクが 0 件のときは非表示。' },
            ...
            { term: 'Obsidian / Logseq エクスポートプリセット', description: 'Obsidian の Properties 形式と Logseq の :: 記法に対応したプリセットを追加。既存の CommonMark / GFM / Hugo / Obsidian コピーと合わせて使える。' },
      ...
      sections: [
        {
          title: '新機能',
          items: [
            { term: 'RSS Reader', description: 'Mark It Down の中でフィードを読み、j/k で移動、Enter で開き、必要な記事だけ Inbox に Markdown として保存できる。' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'LaTeX 環境形式のペースト', description: '\\begin{equation|align|aligned|gather|cases} が自動で $$...$$ に変換され数式レンダリング。Markdown を含まない純粋な LaTeX も通常 Ctrl+V で変換されるように。' },
            { term: 'JSON 通常 Ctrl+V 対応', description: 'JSON → Markdown 変換が通常ペーストでも動作。配列はテーブル、オブジェクトは Key-Value リストに。3 階層以上の深ネストは ```json フェンスブロックにフォールバック。' },
            { term: 'HTML 書式タグの Markdown 変換', description: '<strong>/<b>/<em>/<i>/<code> を除去せず **/*/` に変換。Web や AI 出力の書式情報が失われなくなった。' },
            { term: 'ハンクレベルのコンフリクト解決', description: 'ConflictResolutionModal で j/k によるハンク移動、Shift+←/Shift+→ でフォーカス中のハンクを cherry-pick（ローカル／リモート採用）。' },
          ],
        },
        {
          title: '改善',
          items: [
            ...
            { term: 'Smart Typography パフォーマンス改善', description: '入力イベント毎の state.doc.resolve(from) 呼び出しを 2 回から 1 回に。全祖先チェックをインラインループに畳み込み。' },
          ],
        },
        {
          title: 'バグ修正',
          items: [
            ...
            { term: 'math block が placeholder のまま表示', description: '```math フェンス変換後に converted 文字列で再判定して CodeMirror init をスケジュールする形に修正。' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: '新機能',
          items: [
            { term: '矢印・em-dash 自動変換', description: '-> で →、-- で — に変換。コードブロック内は変換されない。' },
            { term: 'Mermaid セマンティックカラー', description: ':::frontend、:::backend、:::database などのクラス名でテーマに合わせた色が自動付与。' },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'スラッシュコマンド', description: 'エディタ再表示後に/コマンドが反応しなくなる問題を修正。' },
      ...
      sections: [
        {
          title: '新機能',
          items: [
            { term: 'Web Clipper CSSセレクター指定', description: 'ドロップダウンでページセクション（main、article、#content）を選んでクリップ。長いページから必要な部分だけを正確に取り込める。' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'Chat Format Smart Paste', description: 'Slack・Discord・WhatsApp からのペーストで、固有記法（<url|テキスト>、||スポイラー||、>>> 引用など）を標準 Markdown に自動変換。' },
            { term: 'EPUBエクスポート', description: 'Mermaid図・数式・コードハイライトを含む EPUB 3.0 形式で出力。単一ノートとバッチ出力に対応。' },
            { term: 'LaTeXエクスポート', description: 'Markdown を LaTeX に変換して .tex ファイルとして出力。学術文書・論文の下書きに。' },
            ...
            { term: '見出し自動番号付け', description: 'H2〜H6 に CSS カウンターで自動連番を付ける。スラッシュメニュー /num でオン/オフを切替。' },
            { term: '数学ブロック内LaTeXコマンド補完', description: '数式ブロック内で \\ を入力すると108種類のコマンド候補を表示。ギリシャ文字・演算子・矢印など。' },
            { term: 'TOC強化', description: '子見出しを持つ見出しに折りたたみボタンを追加。TOC下部に「先頭・末尾・前後見出し・ページアップ/ダウン」の6ナビゲーションボタンを設置。' },
            { term: '全ノート横断 Find & Replace', description: 'Ctrl+Shift+H で全ノートを横断して検索・置換。フォルダフィルターチップ、「3 / 17」形式の現在位置表示、Ctrl+F で検索専用モードを追加。' },
          ],
        },
        {
          title: '変更',
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'x.comのCallout', description: 'Grokの[!NOTE]/[!WARNING]等のCalloutがx.comからのクリップで保持されるようになった' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { term: 'コマンドパレットでノート検索', description: 'Ctrl+Shift+Pからノート名で検索して直接開ける' },
          ],
        },
        {
          title: 'テーマ & デザイン',
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          title: 'ツールバー全面リデザイン',
          items: [
            { term: 'L1/L2の2層構造', description: 'L1（基本操作）は日常的なボタンのみ。L2（詳細操作）は···で展開 — すっきりしたまま、機能はそのまま' },
            ...
            { term: 'Lucideアイコン統一', description: '~200個のインラインSVGをlucide-preactライブラリに統一。バンドルサイズ10.44KB削減' },
          ],
        },
        {
          title: 'Cross-Instance Compare & Edit',
          items: [
            { term: 'ウィンドウ間の衝突を検知', description: 'New TabとSide Panelで同じノートを開いても、片方の編集が消えない。chrome.storage.sessionにスナップショットを自動保存（3秒throttle）' },
        ...
        },
        {
          ...
          items: [
            ...
            { term: 'Smart Defaults', description: 'max-width: 400pxで長文自動折り返し、min-width: 3ch/4chでセルの潰れ防止' },
          ],
        },
        {
          title: '新機能',
          items: [
            ...
            { term: 'Calloutタイプ切り替え', description: 'Ctrl+Shift+AでNOTE→TIP→IMPORTANT→WARNING→CAUTIONを循環。ツールバーとコマンドパレットからも操作可能' },
        ...
        },
        {
          title: 'バグ修正',
          items: [
            { term: '取り消し線', description: '~~text~~が入力中にすぐ反映されるように。IMEでも対応' },
            ...
            { term: 'コードシンタックスハイライト', description: '3テンプレートのcolor: inherit !importantがCodeMirrorのスタイルを上書きする問題を修正' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          title: 'エクスポートスイート',
          items: [
            { term: 'PDF出力', description: 'ブラウザの印刷ダイアログからPDFへ — H1で自動改ページ、---を改ページに変換' },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { term: '構文プレビュー', description: 'スニペット説明を構文例に変更: graph TD — Decision flows with arrows' },
        ...
        },
        {
          title: 'バグ修正',
          items: [
            { term: 'Windows TOC修正', description: '\\r\\n改行で見出し抽出が失敗する問題を修正' },
            { term: 'テキストコピー修正', description: 'LaTeX $...$ やエスケープ文字を正しく除去' },
            { term: 'ドル金額の誤検出', description: '$50がLaTeX数式として除去されなくなった' },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: 'ノート移動', description: 'Ctrl+Alt+PgUp/PgDnで同フォルダ内のノート間をジャンプ' },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: '脚注', description: '学術スタイルの[^label]構文、クリックでジャンプ' },
            { term: '絵文字ショートコード', description: ':smile:で😄に変換' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          items: [
            ...
            { term: 'キーボードナビゲーション', description: '見出しジャンプ（Ctrl+↑/↓）、ページスクロール' },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      sections: [
        {
          items: [
            { term: '数式レンダリング', description: 'インライン$...$、ブロック$$...$$、拡大ボタン付き' },
...
// not here. The old JA CTA link had a literal '?hl=ja' query param appended
// to the same URL — dropped here, matching the existing non-branching
// CWS_URL precedent already established for templates.ts / features.ts.
