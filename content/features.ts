...
// "1ペイン。集中できる。<br>書いて、すぐ見る。"); dropped and joined into one
// reflowing string, same precedent as content/index.ts's own note on
// dropping presentational <br> line breaks.
//
...
export const featuresContent: Record<Lang, FeaturesCopy> = {
  en: {
    ...
    heroSubtitle: 'One pane. No distractions. Write, see instantly.',
  },
  ja: {
    lang: 'ja',
    ...
    heroSubtitle: '1ペイン。集中できる。書いて、すぐ見る。',
  },
};
...
export interface FeaturesListItem {
  ...
  // rss.html / okf.html). Rendered by FeatureSection as a separate link line
  // after the body paragraph rather than as an inline mid-sentence anchor, so
  // `body` stays plain text. `slug` is resolved through navHref() so it flips
  // between e.g. clipper.html/clipper-ja.html per lang like every other
  // internal link in this codebase; `label` is the old page's exact anchor
  // text.
...
//
// Dropped from every category: the old design's decorative accordion icon
// glyphs/version badges, the <img src="wax-seal.png"> in the View category's
// "4 Themes" item (DESIGN.md §8 rejects the wax-seal motif), and the inline
// Git SVG icon in the Git Sync category. The Web Clipper / RSS Reader
// "Learn More" trailing item and the inline hyperlink in Storage's "OKF
// Export" item were restored per #1593 Phase 3-3 review (see `link` on
// FeaturesListItem above) — docs/features.html links these to clipper.html /
// rss.html / okf.html respectively. <kbd> tags
// (Ctrl+Shift+E / Ctrl+Shift+C) are flattened to plain "Ctrl+Shift+E" /
// "Ctrl+Shift+C" text, matching the Keyboard Shortcuts category's own
// plain-text shortcut notation.
  ...
  en: {
    webClipper: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Mermaid.js diagram source code recovered and saved as ```mermaid code blocks.',
        },
        {
        ...
        },
        {
          ...
          body: 'Pages with <ruby> annotations (common in Japanese content) convert automatically to 漢字《かんじ》 notation. Long articles that mix footnotes, tables, code blocks, and images also clip more accurately.',
        },
        {
          title: 'Learn More',
    ...
    rssReader: {
      ...
      items: [
        {
          title: 'Feed Viewer',
          body: 'Open RSS from the sidebar, command palette, or Ctrl+Shift+R. Move with j/k, open with Enter or o, save with i.',
        },
        {
        ...
        },
        {
          ...
          body: "Enable scheduled refresh in RSS settings and feeds update automatically at your configured interval — no need to keep the tab open. Uses Chrome's alarms API; the schedule survives browser restarts.",
        },
        {
        ...
        },
        {
          ...
          body: 'Feed requests include If-None-Match and If-Modified-Since headers. Unchanged feeds return 304 and skip parsing — less bandwidth, faster cycles.',
        },
        {
    ...
    repositoryReader: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "Header buttons and Alt+←/→ retrace files you've already opened in the session.",
        },
        {
    ...
    noteGraph: {
      ...
      items: [
        ...
        {
          title: 'Radial View',
          body: 'Linked notes arranged around a center node. Zoom with the mouse wheel or Ctrl+wheel, pan by dragging, and reset with the overlay Reset/+/− buttons.',
        },
        {
    ...
    portability: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Write [[Note Title]] or [[Title|Alias]]. Type [[ for a fuzzy-search autocomplete popover. Resolved links are green, unresolved red, ambiguous amber. Ctrl+Click to navigate.',
        },
        {
          title: 'Obsidian Properties + Logseq Export Presets',
          body: 'Built-in presets for Obsidian Properties format and Logseq :: notation, alongside the existing CommonMark / GFM / Hugo / Obsidian copy targets.',
        },
        {
    ...
    markdown: {
      ...
      items: [
        ...
        {
          title: 'Math (LaTeX)',
          body: 'Inline $...$, block $$...$$. Open in new tab, save as Retina 2x PNG.',
        },
        {
          title: 'Callouts',
        ...
        {
          title: 'Page Links',
          body: 'Internal navigation with [Text](#heading).',
        },
        {
          title: 'Footnotes',
          body: 'Academic-style [^label] — insert via modal with auto-numbering, or type directly. Edit and delete from hover toolbar.',
        },
        {
          title: 'Emoji Shortcodes',
          body: 'Type :smile: to insert 😄.',
        },
        {
          title: 'Tables',
        ...
        },
        {
          ...
          body: '<details>/<summary> click-to-expand. Insert via slash menu /details.',
        },
        {
        ...
        },
        {
          ...
          body: 'Type \\ inside a math block for 108 LaTeX command suggestions (Greek letters, operators, arrows, etc.).',
        },
        {
    ...
    view: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'Inbound [[links]] pointing to the current note appear in a collapsible "Links here" list at the bottom of the TOC and in the Right Panel. Each entry shows the source note title, line number, and a preview of the surrounding text. Click or Enter to jump to the source note. Hidden when there are no backlinks.',
        },
        {
    ...
    storage: {
      ...
      items: [
        ...
        {
          title: 'Export',
          body: 'PDF (page numbers, TOC, custom margins), DOCX (images, diagrams, math embedded), PNG (2x Retina), HTML (3 templates, self-contained), EPUB (Mermaid, math, code highlighting), LaTeX (.tex, heading→\\section mapping) — Ctrl+Shift+E.',
        },
        {
          title: 'OKF Export',
          body: 'Open Knowledge Format — export notes as .okf.zip with generated frontmatter, a self-contained concept graph viewer, and an activity log. A citations section is auto-generated from links in the note body, and relative Markdown links between notes convert to bundle-relative OKF paths. Git sync also writes OKF-compatible files.',
          link: { label: 'Open Knowledge Format', slug: 'okf' },
        },
        {
          title: 'Semantic HTML output',
          body: 'HTML and EPUB export render captioned images as <figure><figcaption>, table headers as <th scope="col">, and the TOC as a labeled <nav> — Markdown source unchanged.',
        },
        {
        ...
        },
        {
          ...
          body: 'Copy entire note or selection as rich text (Ctrl+Shift+C). Paste into Word, Notion, or Google Docs with formatting intact.',
        },
        {
      ...
      groups: [
        {
          ...
          items: [
            {
              title: 'mid + Space (address bar)',
              body: "Type mid in Chrome's address bar and press Space to search notes by title. Press Enter to open the note in a new tab — keyboard only, no mouse required.",
            },
            {
              title: 'Line Number Jump',
              body: 'Command Palette → "Go to line" — jump the cursor to any line number. Useful in long technical notes.',
            },
            { title: 'Ctrl+K', body: 'Search.' },
            { title: 'Ctrl+Shift+P', body: 'Command Palette.' },
            { title: 'Ctrl+Shift+1', body: 'Notes panel.' },
            { title: 'Ctrl+Shift+2', body: 'TOC panel.' },
            { title: 'Ctrl+Shift+F', body: 'Sidebar search focus.' },
            { title: 'Ctrl+Shift+G', body: 'TOC search focus.' },
            { title: 'Ctrl+Shift+E', body: 'Export menu.' },
            { title: 'I/A/T/M', body: 'Triage selected notes to Inbox, Archive, Trash, or Template.' },
          ],
        },
        {
          heading: 'Editing',
          items: [
            { title: 'Alt+N', body: 'New note.' },
            { title: 'Alt+↑/↓', body: 'Move line.' },
            { title: 'Ctrl+;', body: 'Insert date.' },
            { title: 'Ctrl+F', body: 'Search (no replace).' },
            { title: 'Ctrl+H', body: 'Find & Replace (current note).' },
            { title: 'Ctrl+Shift+H', body: 'All-notes Find & Replace.' },
          ],
        },
        {
          heading: 'View',
          items: [
            { title: 'Alt+F', body: 'Focus Mode.' },
            { title: 'F11', body: 'Fullscreen.' },
            { title: 'Ctrl+↑/↓', body: 'Jump headings (read-only).' },
            { title: 'PgUp/PgDn', body: 'Page scroll.' },
          ],
        },
        {
          ...
          items: [
            ...
            { title: 'Ctrl+Shift+↑/↓', body: 'Reorder headings in TOC (same level).' },
            { title: 'Tab / Shift+Tab', body: 'Demote / promote heading level in TOC.' },
          ],
        },
        {
          heading: 'Notes',
          items: [
            { title: 'Alt+P', body: 'Pin note.' },
            { title: 'Alt+T', body: 'Move to Template.' },
            { title: 'Alt+A', body: 'Move to Archive.' },
            { title: 'Ctrl+Shift+S', body: 'Git sync.' },
            { title: 'Ctrl+Alt+PgUp/PgDn', body: 'Previous/next note in folder.' },
          ],
        },
      ],
    },
  ...
  ja: {
    webClipper: {
      ...
      items: [
        ...
        {
          title: 'Mermaid保持',
          body: 'Mermaid.jsの図のソースコードを復元し、```mermaid コードブロックとして保存。',
        },
        {
          title: 'YouTube字幕取り込み',
        ...
        {
          title: 'ルビ → 青空文庫記法に変換',
          body: '<ruby> タグを含むページを取り込むと 漢字《かんじ》 形式に自動変換される。脚注・表・コードブロック・画像を含む長文ページの取り込み品質も改善した。',
        },
        {
          title: '詳しく見る',
    ...
    rssReader: {
      ...
      items: [
        {
          title: 'フィードビューア',
          body: 'サイドバー、コマンドパレット、Ctrl+Shift+R からRSSを開ける。j/kで移動、Enterまたはoで開き、iで保存。',
        },
        {
        ...
        {
          title: 'バックグラウンド定期取得',
          body: 'RSS設定で定期取得を有効にすると、設定した間隔でフィードがバックグラウンドで自動更新される。タブを開いたままにしなくていい。Chromeのalarms APIを使用。ブラウザ再起動後も自動で再登録される。',
        },
        {
          title: 'デスクトップ通知',
        ...
        {
          title: 'Conditional GET（ETag / Last-Modified）',
          body: 'フィードリクエストに If-None-Match / If-Modified-Since ヘッダーを送信。未更新フィードは 304 を返しパースをスキップ——通信量削減、取得サイクル高速化。',
        },
        {
          title: '保持期間の分割設定',
    ...
    repositoryReader: {
      ...
      items: [
        ...
        },
        {
          ...
          body: 'ヘッダーのボタンとAlt+←/→で、セッション内で開いたファイルを前後にたどれる。',
        },
        {
    ...
    noteGraph: {
      ...
      items: [
        ...
        {
          title: '放射状表示',
          body: '中心ノートを軸にリンクしたノートを放射状に配置。マウスホイールまたはCtrl+ホイールでズーム、ドラッグでパン、オーバーレイのReset/+/−ボタンで元に戻せる。',
        },
        {
          title: 'キーボードナビゲーション',
    ...
    portability: {
      ...
      items: [
        ...
        },
        {
          ...
          body: '[[タイトル]] / [[タイトル|表示名]] で書ける。[[ と入力するとファジー検索のポップオーバーが開く。resolved は緑、unresolved は赤、ambiguous は黄色で表示。Ctrl+Click でリンク先ノートに移動。',
        },
        {
          title: 'Obsidian Properties + Logseq エクスポートプリセット',
          body: 'Obsidian の Properties 形式と Logseq の :: 記法に対応したプリセットを追加。既存の CommonMark / GFM / Hugo / Obsidian コピーと組み合わせて使える。',
        },
        {
    ...
    markdown: {
      ...
      items: [
        ...
        { title: '数式 (LaTeX)', body: 'インライン $...$、ブロック $$...$$。別タブで開いてRetina 2x PNGで保存。' },
        { title: 'コールアウト', body: 'NOTE、TIP、IMPORTANT、WARNING、CAUTION。' },
        { title: '自動リンク化', body: 'URLとメールアドレスが自動でリンクに。' },
        { title: 'ページ内リンク', body: '[テキスト](#見出し) で内部ナビゲーション。' },
        {
          title: '脚注',
          body: '学術記法 [^label] — モーダルで自動採番挿入、直接入力も可。ホバーツールバーで編集・削除。',
        },
        { title: '絵文字ショートコード', body: ':smile:で😄に変換。' },
        {
          title: 'テーブル',
        ...
        {
          title: '折りたたみブロック',
          body: '<details>/<summary> をクリックで開閉。スラッシュメニュー /details で挿入。',
        },
        {
          title: '見出し自動番号付け',
        ...
        {
          title: 'LaTeXコマンド補完',
          body: '数学ブロック内で \\ を入力すると108種類のコマンド候補を表示（ギリシャ文字・演算子・矢印等）。',
        },
        {
    ...
    view: {
      ...
      items: [
        ...
        },
        {
          ...
          body: '現在のノートへの被リンク（[[links]]）が「Links here」として目次下部と右パネルに折りたたみ表示される。各項目にリンク元のタイトル・行番号・前後の文脈プレビューを表示。クリックまたは Enter でリンク元ノートへジャンプ。バックリンクが0件のときは非表示。',
        },
    ...
    storage: {
      ...
      items: [
        ...
        {
          title: 'OKF エクスポート',
          body: 'Open Knowledge Format — ノートを .okf.zip として出力。frontmatter の自動生成、self-contained な概念グラフ viewer、activity log を含む。本文中のリンクから自動生成される citations セクションと、ノート間の相対 Markdown リンクをバンドル内の相対パスに変換する機能を追加。Git 同期でも OKF 互換ファイルを出力。',
          link: { label: 'Open Knowledge Format', slug: 'okf' },
        },
        {
          title: 'セマンティック HTML 出力',
          body: 'HTML・EPUB エクスポートはキャプション付き画像を <figure><figcaption>、テーブルヘッダを <th scope="col">、TOC を named <nav> として出力。Markdown ソースは変更なし。',
        },
        {
          title: '出力先別コピー',
      ...
      groups: [
        {
          ...
          items: [
            {
              title: 'mid + Space（アドレスバー）',
              body: 'Chrome のアドレスバーで mid と入力してスペースを押すとノートをタイトルで検索できる。Enter で新規タブに開く。マウス不要。',
            },
            {
              title: '行番号ジャンプ',
              body: 'コマンドパレット →「指定行へ移動」で任意の行にカーソルを飛ばせる。長い技術メモで便利。',
            },
            { title: 'Ctrl+K', body: '検索。' },
            { title: 'Ctrl+Shift+P', body: 'コマンドパレット。' },
            { title: 'Ctrl+Shift+1', body: 'Notesパネル。' },
            { title: 'Ctrl+Shift+2', body: 'TOCパネル。' },
            { title: 'Ctrl+Shift+F', body: 'サイドバー検索にフォーカス。' },
            { title: 'Ctrl+Shift+G', body: 'TOC検索にフォーカス。' },
            { title: 'Ctrl+Shift+E', body: 'エクスポートメニュー。' },
            { title: 'I/A/T/M', body: '選択中のノートを Inbox / Archive / Trash / Template へ振り分け。' },
          ],
        },
        {
          heading: '編集',
          items: [
            { title: 'Alt+N', body: '新規ノート。' },
            { title: 'Alt+↑/↓', body: '行移動。' },
            { title: 'Ctrl+;', body: '日付挿入。' },
            { title: 'Ctrl+F', body: '検索（置換欄なし）。' },
            { title: 'Ctrl+H', body: '検索・置換（現在のノート）。' },
            { title: 'Ctrl+Shift+H', body: '全ノート横断 Find & Replace。' },
          ],
        },
        {
          heading: '表示',
          items: [
            { title: 'Alt+F', body: 'Focus Mode。' },
            { title: 'F11', body: '全画面。' },
            { title: 'Ctrl+↑/↓', body: '見出しジャンプ（読取専用）。' },
            { title: 'PgUp/PgDn', body: 'ページスクロール。' },
          ],
        },
        {
          heading: 'TOC & 構造',
          items: [
            ...
            { title: 'Ctrl+Shift+↑/↓', body: 'TOC内の見出しを並び替え（同レベルのみ）。' },
            { title: 'Tab / Shift+Tab', body: 'TOC内の見出しレベルを降格 / 昇格。' },
          ],
        },
        {
          heading: 'ノート',
          items: [
            { title: 'Alt+P', body: 'ピン。' },
            { title: 'Alt+T', body: 'Templateへ移動。' },
            { title: 'Alt+A', body: 'Archiveへ移動。' },
            { title: 'Ctrl+Shift+S', body: 'Git同期。' },
            { title: 'Ctrl+Alt+PgUp/PgDn', body: '前後のノートへ移動。' },
          ],
        },
      ],
    },
