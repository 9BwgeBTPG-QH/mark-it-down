...
export const indexSections: Record<Lang, IndexSectionsCopy> = {
  en: {
    ...
    recentStatus: 'v2.3.1 — More reliable rendering, calmer busy states, and smoother large notes.',
    recentItems: [
      {
        title: 'Math and Mermaid render on first load',
        body: 'Math and Mermaid code blocks now render correctly when a note opens, so diagrams and equations do not need a refresh to appear.',
      },
      {
        title: 'Large notes stay responsive sooner',
        body: 'Large notes and Mermaid-heavy notes prioritize visible work first, keeping the editor usable while background rendering continues.',
      },
      {
        title: 'Specific activity states',
        body: 'Git sync, Web Clipper saves, Repository Reader imports, and RSS fetches now show small activity indicators that keep their readable labels.',
      },
      {
        title: 'Auto-hide controls hold steady',
        body: 'Top controls, Focus Mode, side panels, and overlay sidebars stay available during resize, drag, context-menu, and panel transitions.',
      },
      {
        title: 'Quieter rendering fixes',
        body: 'Mermaid source/diagram toggles no longer enter a blank state, and fenced math blocks keep a readable layout in the live editor.',
      },
    ],
    faqEyebrow: 'FAQ',
    ...
    ctaVersion: 'Latest version: v2.3.1',
  ...
  ja: {
    ...
    recentStatus: 'v2.3.1 — 描画の安定化、静かな処理中表示、大容量ノートの軽さ。',
    recentItems: [
      {
        title: '数式と Mermaid を初回表示から描画',
        body: '数式と Mermaid のコードブロックが、ノートを開いた時点で正しくレンダリングされる。再読み込みしなくても図と数式を確認できる。',
      },
      {
        title: '大容量ノートの操作開始を軽く',
        body: '大容量ノートや Mermaid の多いノートでは、見えている範囲の処理を優先する。裏側の描画を待たずに編集を始めやすい。',
      },
      {
        title: '処理中の状態を見分けやすく',
        body: 'Git 同期、Web Clipper 保存、Repository Reader インポート、RSS 取得に、小さなアクティビティ表示を追加。読めるラベルはそのまま残る。',
      },
      {
        title: '自動非表示 UI が操作中に消えにくく',
        body: '上部バー、Focus Mode、Side Panel、オーバーレイ Sidebar が、リサイズ、ドラッグ、コンテキストメニュー、パネル遷移中も安定して残る。',
      },
      {
        title: '描画まわりの静かな修正',
        body: 'Mermaid のソース/図切り替えで空白状態にならず、 fenced math block もライブエディタ内で読みやすい表示を保つ。',
      },
    ],
    faqEyebrow: 'FAQ',
    faqHeading: 'よくある質問',
